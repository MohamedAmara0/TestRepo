...
//		// Use true to hide the screen title line
//		GraphicsConsole c = new GraphicsConsole(true, width, height);
//		// This line avoids the problem of Java not finding the file.  Need to put the file in the bin folder.  That is where the code is executed.  
...
//		// Stop the program for 2 seconds, then overwrite the cat.
//		Thread.sleep(2000);
		...
		GraphicsConsole c = new GraphicsConsole(width, height);		//Graphics console everything is done on
